  ...
  return (
    ...
    >
      <div className=" flex flex-col items-center justify-center p-1 gap-1 ">
        <div className="flex justify-center items-center relative after:ml-0.5 after:bg-green-500 after:rounded-full after:size-5 after:absolute after:bottom-3 after:right-1 after:content-[' ']">
          <img className="w-30 rounded-full" src={img} alt="" />
        </div>
