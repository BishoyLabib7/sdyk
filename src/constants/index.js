...
export const categories = [
  ...
  { name: "المخبوزات" },
  { name: "أطعمة ومستلزمات الحيوانات الأليفة" },
  { name: "الإلكترونيات والأجهزة المنزلية" },
  { name: "موبايلات، تابلت وأجهزة اليد الذكية" },
  { name: "منتجات الجمال والعناية الشخصية" },
  { name: "منتجات الرياضة و اللياقة البدنية" },
  { name: "أدوات التنظيف المنزلية" },
  { name: "ادوات مدرسيه" },
  { name: "العاب اطفال" },
  { name: "منتجات ورقية، صحف وغيرها" },
  { name: "ملابس، أكسسوارات وحقائب" },
  { name: "أكسسوارات السيارات" },
];
